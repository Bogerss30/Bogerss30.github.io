...
<link rel="stylesheet" href="../assets/css/styleAlambre_pua.css" />
    <main>
        <div class="container__cover div__offset">
            <div class="container-all">
                <div class="cover_slide">
                    <section class="img_slide__cover">
                        <input type="radio" id="1" name="mage-slide" hidden/>
                        <input type="radio" id="2" name="mage-slide" hidden/>
                        <input type="radio" id="3" name="mage-slide" hidden/>
                        <div class="slide">
                            <div class="item-slide">
                                <img src="../assets/images/Servicios/1920x1200_1.png" alt="">
                            </div>

                            <div class="item-slide">
                                <img src="../assets/images/Servicios/1920x1200_2.png" alt="">
                            </div>

                            <div class="item-slide">
                                <img src="../assets/images/Servicios/1920x1200_3.png" alt="">
                            </div>
